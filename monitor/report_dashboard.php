...
<body>
    <div class="wrap">
        ...
        <div class="row">
            <div class="card">
                <h3>Promedio por día de semana</h3><canvas id="cDow"></canvas>
            </div>
            <div class="card">
                <h3>Promedio por hora</h3><canvas id="cHour"></canvas>
            </div>
        </div>

        <div class="row" style="margin-top:16px">
            <div class="card">
                <h3>Tendencia (máx diario)</h3><canvas id="cTrend"></canvas>
            </div>
            <div class="card">
