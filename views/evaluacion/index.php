    ...
    <section class="home-hero-banner">
        <div class="home-container home-hero-wrap">
            ...
            <div class="home-hero-logo small">
                <img src="../../resources/media/general/logo-indara-transparente.png" alt="ÍNDARA Consultores">
            </div>
        </div>
    </section>
    ...
    <main class="home-container home-main">
        ...
        <section id="producto" class="home-product home-section">
            ...
            <article class="home-feature-block">
                ...
                <img src="../../resources/media/evaluacion/demo-global.png" alt="Filtrado por riesgo y norma (demo)" class="home-feature-img">
            </article>
            ...
            <article class="home-feature-block">
                ...
                <img src=".../resources/media/evaluacion/demo-actividad.png" alt="Indicadores por actividad (demo)" class="home-feature-img">
            </article>
            ...
            <article class="home-feature-block">
                ...
                <img src="../../resources/media/evaluacion/demo-filtro.png" alt="Indicador global de riesgo (demo)" class="home-feature-img">
            </article>
            ...
            <article class="home-feature-block">
                ...
                <img src="../../resources/media/evaluacion/demo-validacion.png" alt="Validación de respuestas incompletas (demo)" class="home-feature-img">
            </article>
